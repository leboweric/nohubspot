            ...
            <div className="bg-card border rounded-lg p-6">
              ...
              {invites.length > 0 && (
                <div className="space-y-3 mt-6">
                  <h3 className="text-sm font-medium">Team Invitations</h3>
                  <div className="space-y-2">
                    {invites.map((invite) => {
                      ...
                      return (
                        <div key={invite.id} className={`flex items-center justify-between p-3 rounded-lg ${
